...
namespace DataArc.Orchestration.Framework.Demo.Application.Modules.HR.Adapters
{
    internal class HROrchestrationAdapter : IHROrchestrationPort
    {
        ...
        public async Task<PrepareEmployeeOnbardingOutput> PrepareEmployeeOnboardingAsync(PrepareEmployeeOnboardingInput prepareEmployeeOnbardingInput)
           => await _orchestrator
               .OrchestrateAsync<PrepareEmployeeOnboardingOrchestrator, PrepareEmployeeOnbardingOutput>(
                       prepareEmployeeOnbardingInput,
                       new PrepareEmployeeOnbardingOutput());
